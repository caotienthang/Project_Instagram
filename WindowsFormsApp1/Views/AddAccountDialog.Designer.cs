...
namespace WindowsFormsApp1.Views
{
    partial class AddAccountDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            _lblSubtitle.Text      = "Chọn phương thức đăng nhập";
            ...
            // DESCRIPTION
            // ═══════════════════════════════════════════════════════════
            _lblMessage.Text      = "Đăng nhập bằng máy tính sẽ mở WebView2 để lấy Cookie tự động.\r\nĐăng nhập bằng điện thoại cho phép nhập thông tin thủ công.";
            _lblMessage.Font      = new Font("Segoe UI", 9F);
            _lblMessage.ForeColor = Color.FromArgb(80, 90, 120);
            _lblMessage.Location  = new Point(20, 72);
            _lblMessage.Size      = new Size(420, 36);
            ...
            btnComputer.BackColor = Color.FromArgb(64, 93, 230);
            btnComputer.ForeColor = Color.White;
            btnComputer.FlatStyle = FlatStyle.Flat;
            btnComputer.FlatAppearance.BorderSize         = 0;
            btnComputer.FlatAppearance.MouseOverBackColor = Color.FromArgb(50, 75, 195);
            ...
            btnPhone.BackColor = Color.FromArgb(22, 160, 133);
            btnPhone.ForeColor = Color.White;
            btnPhone.FlatStyle = FlatStyle.Flat;
            btnPhone.FlatAppearance.BorderSize         = 0;
            btnPhone.FlatAppearance.MouseOverBackColor = Color.FromArgb(17, 128, 106);
